    ...
    <div class="w-2/3 flex flex-col mx-auto mt-4 mb-20">
        <div class="mb-4 flex flex-col space-y-2">
            ...
            <p>
                ...
                behalf
                of
                an entity (“<b>you</b>”) and Audioly LLC ("Company ", “<b>we</b>”, “<b>us</b>”, or “<b>our</b>”),
                concerning
                your access to and use of the htpps://http://www.audioly.com/ website as well as any other media form,
                media
                channel, mobile website or mobile application related, linked, or otherwise connected thereto
                (collectively,
                the
                “Site”). We are registered in England and have our registered office at Fern Barrow , Poole , Dorset
                BH12
                5BB .
            ...
            <p>
                ...
                which
                Terms
                apply. You will be subject to, and will be deemed to have been made aware of and to have accepted, the
                changes
                in any revised Terms of Use by your continued use of the Site after the date such revised Terms of Use
                are
                posted.
            </p>
            <p>
                ...
                would
                subject us to any registration requirement within such jurisdiction or country. Accordingly, those
                persons
                who
            ...
            <p>
                ...
                supervised
                by,
                their parent or guardian to use the Site. If you are a minor, you must have your parent or guardian read
                and
                agree to these Terms of Use prior to you using the Site.
            </p>
        </div>
        <div class="mb-4 flex flex-col space-y-2">
            <h3 class="font-bold mb-2">2. USER REGISTRATION</h3>
            <p>
        ...
        <div class="mb-4 flex flex-col space-y-2">
            <h3 class="font-bold mb-2">3. PRODUCTS</h3>
            <p>
                We make every effort to display as accurately as possible the colors, features, specifications, and
                details
                of
                the products available on the Site. However, we do not guarantee that the colors, features,
                specifications,
                and
                details of the products will be accurate, complete, reliable, current, or free of other errors, and your
                electronic display may not accurately reflect the actual colors and details of the products. All
                products
                are
        ...
        <div class="mb-4 flex flex-col space-y-2">
            <h3 class="font-bold mb-2">4. PROHIBITED ACTIVITIES</h3>
            <p>
        ...
        <div class="mb-4 flex flex-col space-y-2">
            <h3 class="font-bold mb-2">5. DISCLAIMER</h3>
            <p>
                ...
                YOUR
                ACCESS TO AND USE OF THE SITE, (3) ANY UNAUTHORIZED ACCESS TO OR USE OF OUR SECURE SERVERS AND/OR ANY
                AND
                ALL
                ...
                TRANSMITTED
                TO
                OR THROUGH THE SITE BY ANY THIRD PARTY, AND/OR (6) ANY ERRORS OR OMISSIONS IN ANY CONTENT AND MATERIALS
                OR
                FOR
                ...
                PRODUCT
                OR
                SERVICE ADVERTISED OR OFFERED BY A THIRD PARTY THROUGH THE SITE, ANY HYPERLINKED WEBSITE, OR ANY WEBSITE
                OR
