...
<body class="overflow-y-auto">
    ...
    <div class="w-full mb-20 md:mb-6">
        <div class="leading-loose flex flex-col justify-center items-center mb-2">
            <form method="post" action="includes/completed-order-inc.php" class="max-w-xl m-4 p-4 bg-white rounded shadow-xl">
                ...
                <div class="mt-2">
                    ...
                    <input class="w-full px-2 py-2 text-gray-700 bg-gray-200 rounded" id="address" name="address"
                        ...
                        value="<?php if (isset($_SESSION['billingAddress'])) echo $_SESSION['billingAddress']['address']; ?>">
                </div>
                <div class="mt-2">
                    ...
                    <input class="w-full px-2 py-2 text-gray-700 bg-gray-200 rounded" id="city" name="city" type="text"
                        ...
                        value="<?php if (isset($_SESSION['billingAddress'])) echo $_SESSION['billingAddress']['city']; ?>">
                </div>
                <div class="inline-block mt-2 w-1/2 pr-1">
                    ...
                    <input class="w-full px-2 py-2 text-gray-700 bg-gray-200 rounded" id="country" name="country"
                        ...
                        value="<?php if (isset($_SESSION['billingAddress'])) echo $_SESSION['billingAddress']['country']; ?>">
                </div>
                <div class="inline-block mt-2 -mx-1 pl-1 w-1/2">
                    ...
                    <input class="w-full px-2 py-2 text-gray-700 bg-gray-200 rounded" id="post-code" name="post-code"
                        ...
                        value="<?php if (isset($_SESSION['billingAddress'])) echo $_SESSION['billingAddress']['postCode']; ?>">
                </div>
                <p class="mt-4 text-gray-800 font-medium">Payment information</p>
                <div class="">
                    <label class="text-sm text-gray-600" for="card-number">Card</label>
                    <input class="w-full px-2 py-2 text-gray-700 bg-gray-200 rounded" id="card-number"
                        name="card-number" type="number" placeholder="Card Number" aria-label="Name">
                </div>
                <div class="mt-2">
                    <label class="hidden text-sm text-gray-600" for="country">Card Name</label>
                    <input class="w-full px-2 py-2 text-gray-700 bg-gray-200 rounded" id="card-name" name="card-name"
                        type="text" placeholder="Card Name" aria-label="Name">
                </div>
                <div class="inline-block mt-2 w-1/2 pr-1">
                ...
                <div class="inline-block mt-2 -mx-1 pl-1 w-1/2">
                    ...
                    <input class="w-full px-2 py-2 text-gray-700 bg-gray-200 rounded" id="cvv" name="cvv" type="number"
                        placeholder="CVV">
                </div>
                <div class="mt-4">
                    <label class="inline-flex items-center">
                        <input type="checkbox" class="form-checkbox h-5 w-5 text-gray-600" required><span
                            class="ml-2 text-gray-700">I agree to the <a href="tos.php" class="underline">Terms and
                                Conditions</a></span>
                    </label>
                    <div class="mt-4">
                        <button class="px-4 py-1 text-white text-bold tracking-wider bg-gray-900 rounded w-full"
                            type="submit" name="submit" value="Card">£<?php if (isset($_SESSION['userId'])) { echo getCartTotal($conn)[0]['total']; } else { echo getCartTotalUnlogged(); }?></button>
                        <button
                            class="px-4 py-1 text-white text-bold tracking-wider bg-indigo-500 hover:bg-indigo-600 rounded w-full my-2"
                            type="submit" name="submit" value="Paypal">PayPal</button>
                    </div>
            </form>
        </div>
    </div>
    <?php
        ...
        if(isset($_GET['error'])) {
            ...
            switch ($urlMessage) {
                case "emptyInput":
                    $toast = "error";
                    $message = "Fill in your card details.";
